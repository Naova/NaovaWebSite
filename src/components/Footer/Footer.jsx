            ...
            <div id="tf-footer">
                <div className="container">
                    ...
                    <ul className="list-inline social pull-right">
                        ...
                        <li><a href="https://github.com/Naova" target="_blank" rel="noopener noreferrer"><i className="fa fa-github"></i></a></li>
                        ...
                        <li><a href="https://www.linkedin.com/company/club-naova" target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
        );
