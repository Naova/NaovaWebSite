					...
					<div className="container">
						<div className="content-heading text-center">
							<center>
								<img
									src={naovaLogo_img}
									className="intro-logo img-responsive"
									alt="Naova Logo"
								/>
							</center>
							<h1>
								<FormattedMessage
									id="header.title"
									defaultMessage="Robotic scientific club"
								/>
							</h1>
							<p className="lead">
								<FormattedMessage
									id="header.school"
									defaultMessage="Ecole de Technologie Supérieure, Montréal"
								/>
							</p>
							<div className="col-md-12 row align-items-center partenaire-wrapper">
								...
								<div className="col-sm">
									<a href="https://www.aeets.com/">
										<img
											src={aeetsLogo_img}
											className="partenaire_aeets_img"
											alt="AEETS"
										/>
									</a>
								</div>
								<div className="col-sm">
									<a href="https://www.rousseau.com/int_fr/">
										<img
											src={rousseauLogo_img}
											className="partenaire_rousseau_img"
											alt="Rousseau"
										/>
									</a>
								</div>
								<div className="col-sm">
									<a href="https://www.teledyne.com/">
										<img
											src={teledyneLogo_img}
											className="partenaire_teledyne_img"
											alt="Teledyne"
										/>
									</a>
								</div>
							...
							<div className="col-md-12">
								<a
									href="#tf-presentation"
									className="scroll goto-arrow"
								>
